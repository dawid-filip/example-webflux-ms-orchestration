...
public class ProductHandler {
    ...
    public Mono<ServerResponse> getPublic(ServerRequest request) {
        log.info("In [/public] (product) endpoint...");

        return ServerResponse.status(HttpStatus.OK)
                .body(Mono.just("""
                        {
                           "product":"This is PUBLIC resource"
                        }"""), String.class);
    }
    ...
    public Mono<ServerResponse> getAll(ServerRequest request) {
        ...
        return ServerResponse.status(HttpStatus.OK)
                .body(this.productService.getAll(), List.class);
    }
